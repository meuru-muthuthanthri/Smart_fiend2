...
//
          ...
          //  Highgui.imwrite("D:/images/EcannyInput.jpg", image);
...
velvet   vel_vet
*/
            return word;/// new String[]{word,filepath,meaning};
        } catch (IOException ex) {
            ex.printStackTrace();
            return null;
        }
    ...
    public static void test() throws IOException
    {
        ...
        Mat sourceImage= Highgui.imread("D:/images/white.jpg");
           Mat grey = new Mat();
           Imgproc.cvtColor(sourceImage, grey, Imgproc.COLOR_BGR2GRAY);
       // convert mat to Buffered image
            MatOfByte byteMat = new MatOfByte();
            ...
            for (int j = 0; j < grey.height(); j++) { // height
                for (int i = 0; i < grey.width(); i++) { // width
 
                        System.out.println(j+" "+i+" "+(buffImage.getRGB(i, j) & 0xFF));
                }
            }
